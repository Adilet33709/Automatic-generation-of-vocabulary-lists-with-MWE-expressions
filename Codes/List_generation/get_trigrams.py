...
## Save to excel
pd.DataFrame(list_of_dicts_auto_list).to_excel("Resources/Auto_list_trigram_freqs_OSEWB.xlsx", index=None)
pd.DataFrame(list_of_dicts_EFLlex).to_excel("Resources/EFLlex_trigram_freqs_OSEWB.xlsx", index=None)